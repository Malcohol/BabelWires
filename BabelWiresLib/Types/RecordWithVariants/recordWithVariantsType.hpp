...
namespace babelwires {
    ...
    class RecordWithVariantsType : public CompoundType {
      ...
      public:
        ...
        std::tuple<const ValueHolder*, PathStep, TypeExp> getChild(const ValueHolder& compoundValue, unsigned int i) const override;
        std::tuple<ValueHolder*, PathStep, TypeExp> getChildNonConst(ValueHolder& compoundValue, unsigned int i) const override;
