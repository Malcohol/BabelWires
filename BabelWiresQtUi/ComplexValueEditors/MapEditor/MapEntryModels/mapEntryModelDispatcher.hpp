...
namespace babelwires {
    ...
    class MapEntryModelDispatcher {
      public:
        void init(const ValueModelRegistry& valueModelRegistry, const Type& sourceType, const Type& targetType, const MapProjectEntry& entry, unsigned int row, bool isLastRow);
