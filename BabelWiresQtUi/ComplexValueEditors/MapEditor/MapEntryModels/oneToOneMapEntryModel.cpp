...
void babelwires::OneToOneMapEntryModel::init(const ValueModelRegistry& valueModelRegistry, const TypeSystem& typeSystem) {
    ...
    m_sourceValueModel.init(valueModelRegistry, typeSystem, *m_sourceType, toRegularValueHolder(discreteMapEntry.getSourceValue()), false, false);
    m_targetValueModel.init(valueModelRegistry, typeSystem, *m_targetType, toRegularValueHolder(discreteMapEntry.getTargetValue()), false, false);
}
