...
namespace babelwires {
    ...
    template <typename BUNDLE> class DataSerialization {
      public:
        ...
        static ResultT<Data> loadFromFile(const std::filesystem::path& pathToFile, const Context& context,
        ...
        static ResultT<Data> loadFromString(const std::string& string, const Context& context,
