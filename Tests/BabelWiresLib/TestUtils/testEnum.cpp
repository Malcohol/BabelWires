...
testUtils::TestSubEnum::TestSubEnum()
    : babelwires::Enum(getThisIdentifier(), 1,
                       babelwires::Enum::EnumValues{testUtils::getTestRegisteredIdentifier("Bar", 2),
...
testUtils::TestSubSubEnum2::TestSubSubEnum2()
    : babelwires::Enum(getThisIdentifier(), 1,
                       babelwires::Enum::EnumValues{testUtils::getTestRegisteredIdentifier("Erm", 3),
                                                    testUtils::getTestRegisteredIdentifier("Oom", 4)},
                       1) {}
