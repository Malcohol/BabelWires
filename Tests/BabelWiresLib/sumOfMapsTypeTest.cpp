      ...
      public:
        ...
        TestSumOfMapsType(const babelwires::TypeSystem& typeSystem)
            : babelwires::SumOfMapsType(getThisIdentifier(),
                  ...
                  {babelwires::DefaultIntType::getThisIdentifier(), babelwires::DefaultTextType::getThisIdentifier()}, 1, 0) {}
    };
} // namespace
...
TEST(SumOfMapsTypeTest, sumOfMapsTypeConstructor) {
    ...
    EXPECT_EQ(sumOfMapsType.getTargetTypes()[1], babelwires::DefaultTextType::getThisIdentifier());
...
TEST(SumOfMapsTypeTest, validValues) {
    ...
    const auto& defaultTextType = testEnvironment.m_typeSystem.getRegisteredType<babelwires::DefaultTextType>();
    ...
    babelwires::MapValue map1(testEnvironment.m_typeSystem, intType, defaultTextType, babelwires::MapEntryData::Kind::All21);
    babelwires::MapValue map2(testEnvironment.m_typeSystem, rationalType, intType,
                              babelwires::MapEntryData::Kind::All21);
    babelwires::MapValue map3(testEnvironment.m_typeSystem, rationalType, defaultTextType,
                              babelwires::MapEntryData::Kind::All21);
