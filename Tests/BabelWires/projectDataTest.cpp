...
TEST(ProjectDataTest, serialization) {
    ...
    ASSERT_EQ(dataPtr->m_elements.size(), 3);
    {
        ...
        EXPECT_EQ(data->m_factoryIdentifier, libTestUtils::TestFileFeatureFactory::getThisIdentifier());
    ...
    }
    {
        ...
        EXPECT_EQ(data->m_factoryIdentifier, libTestUtils::TestFileFormat::getThisIdentifier());
