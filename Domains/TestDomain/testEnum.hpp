...
// Foo, Bar, Erm, Oom, Boo
    struct TESTDOMAIN_API TestEnum : babelwires::EnumType {
    ...
    // Bar, Erm, Oom
    struct TESTDOMAIN_API TestSubEnum : babelwires::EnumType {
        REGISTERED_TYPE("SubEnum", "SubEnum", "80ba8f33-3851-48b4-a510-52770468d5f6", 1);
        TestSubEnum();
    };

    // Bar, Erm
    struct TESTDOMAIN_API TestSubSubEnum1 : babelwires::EnumType {
        REGISTERED_TYPE("SubSubEnum1", "SubSubEnum1", "5cdf92b9-6d0e-4477-b853-336dafc2828d", 1);
        TestSubSubEnum1();
    };

    // Erm, Oom
    struct TESTDOMAIN_API TestSubSubEnum2 : babelwires::EnumType {
