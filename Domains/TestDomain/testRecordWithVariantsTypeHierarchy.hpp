/**
 * TestRecordWithVariantsTypeHierarchy
 *
...
namespace testDomain {
    ...
    struct TESTDOMAIN_API RecordVWithNoFields : babelwires::RecordWithVariantsType {
    ...
    struct TESTDOMAIN_API RecordVA0 : babelwires::RecordWithVariantsType {
    ...
    struct TESTDOMAIN_API RecordVA1 : babelwires::RecordWithVariantsType {
    ...
    struct TESTDOMAIN_API RecordVB : babelwires::RecordWithVariantsType {
    ...
    struct TESTDOMAIN_API RecordVAB : babelwires::RecordWithVariantsType {
    ...
    struct TESTDOMAIN_API RecordVAS : babelwires::RecordWithVariantsType {
    ...
    struct TESTDOMAIN_API RecordVAV0 : babelwires::RecordWithVariantsType {
    ...
    struct TESTDOMAIN_API RecordVABV0 : babelwires::RecordWithVariantsType {
    ...
    struct TESTDOMAIN_API RecordVABV1 : babelwires::RecordWithVariantsType {
    ...
    struct TESTDOMAIN_API RecordVABV01 : babelwires::RecordWithVariantsType {
    ...
    struct TESTDOMAIN_API RecordVAVB : babelwires::RecordWithVariantsType {
