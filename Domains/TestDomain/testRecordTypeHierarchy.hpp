...
namespace testDomain {
    ...
    struct TESTDOMAIN_API RecordWithNoFields : babelwires::RecordType {
    ...
    struct TESTDOMAIN_API RecordA0 : babelwires::RecordType {
    ...
    struct TESTDOMAIN_API RecordA1 : babelwires::RecordType {
    ...
    struct TESTDOMAIN_API RecordB : babelwires::RecordType {
    ...
    struct TESTDOMAIN_API RecordAB : babelwires::RecordType {
    ...
    struct TESTDOMAIN_API RecordAS : babelwires::RecordType {
    ...
    struct TESTDOMAIN_API RecordAOpt : babelwires::RecordType {
    ...
    struct TESTDOMAIN_API RecordAOptFixed : babelwires::RecordType {
    ...
    struct TESTDOMAIN_API RecordABOpt : babelwires::RecordType {
    ...
    struct TESTDOMAIN_API RecordAOptS : babelwires::RecordType {
    ...
    struct TESTDOMAIN_API RecordABOptChild : babelwires::RecordType {
    ...
    struct TESTDOMAIN_API RecordAsub0 : babelwires::RecordType {
    ...
    struct TESTDOMAIN_API RecordAsubBsup : babelwires::RecordType {
